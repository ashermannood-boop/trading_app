...
<title>crypto-tradenow Verify OTP</title>
<style>
    ...
    <tr>
      <td align="center">
        <div class="container">
          ...
          <p class="footer">© ${new Date().getFullYear()} crypto-tradenow.org</p>
        </div>
      </td>
    </tr>
  </table>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>crypto-tradenow Reset OTP</title>
<style>
  body { margin:0; padding:0; background:#f5f6fa; font-family: Arial, sans-serif; }
  .container { max-width:420px; margin:0 auto; background:#ffffff; border-radius:8px; padding:25px; color:#333; }
  h2 { margin:0; color:#2563eb; }
    ...
    <tr>
      <td align="center">
        <div class="container">
          ...
          <p class="footer">Secure Trading Notifications • crypto-tradenow</p>
        </div>
      </td>
    </tr>
  </table>
...
export const sendVerifyOTP = (email, name, otp) => {
  return sendEmail({
    to: email,
    subject: "Verify Your crypto-tradenow Account",
...
export const sendResetOTP = (email, name, otp) => {
  return sendEmail({
    to: email,
    subject: "Reset Your crypto-tradenow Password",
